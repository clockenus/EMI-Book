...
- [Cloth Config](https://modrinth.com/mod/cloth-config) (optional, for configuring custom behavior)
## Features
...
## Credits
"Two Pages" preset was inspired by EMI config settings used in [Raspberry Flavoured](https://www.curseforge.com/minecraft/modpacks/raspberry-flavoured).
